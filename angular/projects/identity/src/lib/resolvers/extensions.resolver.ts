...
export const identityExtensionsResolver: ResolveFn<any> = () => {
  ...
  const actionContributors: IdentityEntityActionContributors =
    injector.get(IDENTITY_ENTITY_ACTION_CONTRIBUTORS, null) || {};
  const toolbarContributors: IdentityToolbarActionContributors =
    injector.get(IDENTITY_TOOLBAR_ACTION_CONTRIBUTORS, null) || {};
  const propContributors: IdentityEntityPropContributors =
    injector.get(IDENTITY_ENTITY_PROP_CONTRIBUTORS, null) || {};
  const createFormContributors: IdentityCreateFormPropContributors =
    injector.get(IDENTITY_CREATE_FORM_PROP_CONTRIBUTORS, null) || {};
  const editFormContributors: IdentityEditFormPropContributors =
    injector.get(IDENTITY_EDIT_FORM_PROP_CONTRIBUTORS, null) || {};
