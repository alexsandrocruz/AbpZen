...
import { DEFAULT_CLAIMS_ENTITY_ACTIONS } from '../defaults/claims/default-claims-entity-actions';
import { DEFAULT_CLAIMS_ENTITY_PROPS } from '../defaults/claims/default-claims-entity-props';
import {
  DEFAULT_CLAIMS_CREATE_FORM_PROPS,
  DEFAULT_CLAIMS_EDIT_FORM_PROPS,
} from '../defaults/claims/default-claims-form-props';
import { DEFAULT_CLAIMS_TOOLBAR_ACTIONS } from '../defaults/claims/default-claims-toolbar-actions';
import { DEFAULT_ORGANIZATION_MEMBERS_ENTITY_ACTIONS } from '../defaults/organization-unit/default-organization-members-entity-actions';
import { DEFAULT_ORGANIZATION_MEMBERS_ENTITY_PROPS } from '../defaults/organization-unit/default-organization-members-entity-props';
import { DEFAULT_ORGANIZATION_ROLES_ENTITY_ACTIONS } from '../defaults/organization-unit/default-organization-roles-entity-actions';
import { DEFAULT_ORGANIZATION_ROLES_ENTITY_PROPS } from '../defaults/organization-unit/default-organization-roles-entity-props';
import {
  DEFAULT_ORGANIZATION_UNITS_CREATE_FORM_PROPS,
  DEFAULT_ORGANIZATION_UNITS_EDIT_FORM_PROPS,
} from '../defaults/organization-unit/default-organization-units-form-props';
import { DEFAULT_ORGANIZATION_UNITS_TOOLBAR_ACTIONS } from '../defaults/organization-unit/default-organization-units-toolbar-actions';
import { DEFAULT_ROLES_ENTITY_ACTIONS } from '../defaults/roles/default-roles-entity-actions';
import { DEFAULT_ROLES_ENTITY_PROPS } from '../defaults/roles/default-roles-entity-props';
import {
  DEFAULT_ROLES_CREATE_FORM_PROPS,
  DEFAULT_ROLES_EDIT_FORM_PROPS,
} from '../defaults/roles/default-roles-form-props';
import { DEFAULT_ROLES_TOOLBAR_ACTIONS } from '../defaults/roles/default-roles-toolbar-actions';
import { DEFAULT_SECURITY_LOGS_ENTITY_ACTIONS } from '../defaults/security-logs/default-security-logs-entity-actions';
import { DEFAULT_SECURITY_LOGS_ENTITY_PROPS } from '../defaults/security-logs/default-security-logs-entity-props';
import { DEFAULT_SECURITY_LOGS_TOOLBAR_ACTIONS } from '../defaults/security-logs/default-security-logs-toolbar-actions';
import { DEFAULT_USERS_ENTITY_ACTIONS } from '../defaults/users/default-users-entity-actions';
import { DEFAULT_USERS_ENTITY_PROPS } from '../defaults/users/default-users-entity-props';
import {
  DEFAULT_USERS_CREATE_FORM_PROPS,
  DEFAULT_USERS_EDIT_FORM_PROPS,
} from '../defaults/users/default-users-form-props';
import { DEFAULT_USERS_TOOLBAR_ALL } from '../defaults/users/default-users-toolbar-actions';
...
export const DEFAULT_IDENTITY_TOOLBAR_ACTIONS = {
  ...
  [eIdentityComponents.Users]: DEFAULT_USERS_TOOLBAR_ALL,
...
type CreateFormPropContributors = Partial<{
  ...
  [eIdentityComponents.OrganizationUnits]: CreateFormPropContributorCallback<OrganizationUnitWithDetailsDto>[];
}>;
type EditFormPropContributors = Partial<{
  ...
  [eIdentityComponents.OrganizationUnits]: EditFormPropContributorCallback<OrganizationUnitWithDetailsDto>[];
}>;
