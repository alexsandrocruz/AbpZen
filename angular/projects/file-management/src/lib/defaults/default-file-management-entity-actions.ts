import { ActionData, EntityAction } from '@abp/ng.components/extensible';
...
export const DEFAULT_FILE_MANAGEMENT_DIRECTORY_CONTENT_DTO_ENTITY_ACTIONS =
  EntityAction.createMany<DirectoryContentDto>([
    /* DIRECTORY ACTIONS */
    {
    ...
    },
    {
      ...
      action: data => {
        const component = data.getInjected(FileManagementFolderContentComponent);
        component.moveFolder(data.record);
      },
      permission: eFileManagementPolicyNames.DirectoryDescriptorUpdate,
      visible: isDirectory,
    },
