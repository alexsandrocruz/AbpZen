...
export const DEFAULT_FILE_MANAGEMENT_ENTITY_ACTIONS = {
  [eFileManagementComponents.FolderContent]:
    DEFAULT_FILE_MANAGEMENT_DIRECTORY_CONTENT_DTO_ENTITY_ACTIONS,
};

export const DEFAULT_FILE_MANAGEMENT_TOOLBAR_ACTIONS = {
  [eFileManagementComponents.FolderContent]:
    DEFAULT_FILE_MANAGEMENT_DIRECTORY_CONTENT_TOOLBAR_ACTIONS,
};

export const DEFAULT_FILE_MANAGEMENT_ENTITY_PROPS = {
  [eFileManagementComponents.FolderContent]:
    DEFAULT_FILE_MANAGEMENT_DIRECTORY_CONTENT_DTO_ENTITY_PROPS,
};

export const FILE_MANAGEMENT_ENTITY_ACTION_CONTRIBUTORS =
  new InjectionToken<EntityActionContributors>('FILE_MANAGEMENT_ENTITY_ACTION_CONTRIBUTORS');

export const FILE_MANAGEMENT_TOOLBAR_ACTION_CONTRIBUTORS =
  new InjectionToken<ToolbarActionContributors>('FILE_MANAGEMENT_TOOLBAR_ACTION_CONTRIBUTORS');

export const FILE_MANAGEMENT_ENTITY_PROP_CONTRIBUTORS = new InjectionToken<EntityPropContributors>(
