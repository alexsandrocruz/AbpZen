      ...
      where TStartupModule : IAbpModule
{
    ...
    [Fact]
    public async Task GetListWithTenantCountAsync()
    {
        var editions = await EditionRepository.GetListWithTenantCountAsync();
        editions.ShouldContain(t => t.Edition.DisplayName == "FirstEdition" && t.TenantCount == 1);
        editions.ShouldContain(t => t.Edition.DisplayName == "SecondEdition" && t.TenantCount == 0);
    }
