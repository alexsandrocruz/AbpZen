...
public class AbpIdentityTestDataBuilder : ITransientDependency
{
    ...
    private async Task AddClaimTypes()
    {
        ...
        var socialNumberClaim = new IdentityClaimType(_testData.SocialNumberClaimId, "SocialNumber", true, false, "^[0-9]*$", null, null, IdentityClaimValueType.String);
        await _identityClaimTypeRepository.InsertAsync(socialNumberClaim);
    }
