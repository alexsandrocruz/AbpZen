...
{
    public class MongoDbSapienzaZenDbSchemaMigrator : ISapienzaZenDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public MongoDbSapienzaZenDbSchemaMigrator(IServiceProvider serviceProvider)
        {
