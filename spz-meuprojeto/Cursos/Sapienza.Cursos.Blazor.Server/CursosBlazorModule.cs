...
using Sapienza.Cursos.Blazor.Menus;
...
namespace Sapienza.Cursos.Blazor
{
    ...
    public class CursosBlazorModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    ...
                    typeof(CursosBlazorModule).Assembly
                );
            });
        }
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<CursosDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Sapienza.Cursos.Domain.Shared"));
                    ...
                    options.FileSets.ReplaceEmbeddedByPhysical<CursosBlazorModule>(hostingEnvironment.ContentRootPath);
        ...
        private void ConfigureRouter()
        {
            ...
            {
                options.AppAssembly = typeof(CursosBlazorModule).Assembly;
            });
        }
        ...
        private void ConfigureAutoMapper()
        {
            ...
            {
                options.AddMaps<CursosBlazorModule>();
            });
        }
