...
namespace Sapienza.Cursos.MauiBlazor.OAuth
{
    public class CodeFlowExternalAuthService : ExternalAuthServiceBase
    {
        ...
        public CodeFlowExternalAuthService(
            ICursosApplicationSettingService leptonXDemoAppApplicationSettingService,
        ...
        public override async Task<LoginResult> LoginAsync(LoginInput input)
        {
            ...
            await CursosApplicationSettingService.SetAccessTokenAsync(loginResult.AccessToken);
