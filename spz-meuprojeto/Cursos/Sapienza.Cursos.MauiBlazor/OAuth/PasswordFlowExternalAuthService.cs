...
public class PasswordFlowExternalAuthService : ExternalAuthServiceBase
{
    ...
    public PasswordFlowExternalAuthService(
        ...
        ICursosApplicationSettingService leptonXDemoAppApplicationSettingService) : base(leptonXDemoAppApplicationSettingService)
    {
    ...
    public override async Task<LoginResult> LoginAsync(LoginInput loginInput)
    {
        ...
        await CursosApplicationSettingService.SetAccessTokenAsync(tokenResponse.AccessToken);
    ...
    {
        await CursosApplicationSettingService.SetAccessTokenAsync(null);
