...
using Sapienza.Cursos.HealthChecks;
...
{
    [DependsOn(
        typeof(CursosHttpApiModule),
        typeof(AbpAutofacModule),
        typeof(AbpAspNetCoreMultiTenancyModule),
        typeof(CursosApplicationModule),
        typeof(CursosMongoDbModule),
    ...
    public class CursosHttpApiHostModule : AbpModule
    {
         public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            PreConfigure<OpenIddictBuilder>(builder =>
            {
                ...
                {
                    options.AddAudiences("Sapienza.Cursos");
        ...
        {
            context.Services.AddCursosHealthChecks();
        }
        ...
        private void ConfigureConventionalControllers()
        {
            ...
            {
                options.ConventionalControllers.Create(typeof(CursosApplicationModule).Assembly);
            });
        }
        ...
        private void ConfigureAuthentication(ServiceConfigurationContext context, IConfiguration configuration)
        {
            context.Services.AddAuthentication()
                .AddJwtBearer(options =>
                {
                    ...
                    options.Audience = "Sapienza.Cursos";
        ...
        private static void ConfigureSwagger(ServiceConfigurationContext context, IConfiguration configuration)
        {
            context.Services.AddAbpSwaggerGenWithOAuth(
                ...
                {
                    {"Sapienza.Cursos", "Sapienza.Cursos API"}
                },
                options =>
                {
