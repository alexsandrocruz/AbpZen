...
{
    public class MongoDbCursosDbSchemaMigrator : ICursosDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public MongoDbCursosDbSchemaMigrator(IServiceProvider serviceProvider)
        {
