...
using Sapienza.EventoZen.MauiBlazor.Navigation;
...
public class EventoZenMauiBlazorModule : AbpModule
{
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new EventoZenMenuContributor(context.Services.GetConfiguration()));
        });
    }

    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        Configure<AbpRouterOptions>(options => { options.AppAssembly = typeof(EventoZenMauiBlazorModule).Assembly; });
    }
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddMaps<EventoZenMauiBlazorModule>();
        });
    }
