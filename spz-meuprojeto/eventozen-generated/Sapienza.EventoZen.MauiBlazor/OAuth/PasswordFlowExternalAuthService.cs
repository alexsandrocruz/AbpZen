...
public class PasswordFlowExternalAuthService : ExternalAuthServiceBase
{
    ...
    public PasswordFlowExternalAuthService(
        ...
        IEventoZenApplicationSettingService leptonXDemoAppApplicationSettingService) : base(leptonXDemoAppApplicationSettingService)
    {
    ...
    public override async Task<LoginResult> LoginAsync(LoginInput loginInput)
    {
        ...
        await EventoZenApplicationSettingService.SetAccessTokenAsync(tokenResponse.AccessToken);
    ...
    {
        await EventoZenApplicationSettingService.SetAccessTokenAsync(null);
