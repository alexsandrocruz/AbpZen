...
namespace Sapienza.EventoZen.MauiBlazor.OAuth
{
    public class CodeFlowExternalAuthService : ExternalAuthServiceBase
    {
        ...
        public CodeFlowExternalAuthService(
            IEventoZenApplicationSettingService leptonXDemoAppApplicationSettingService,
        ...
        public override async Task<LoginResult> LoginAsync(LoginInput input)
        {
            ...
            await EventoZenApplicationSettingService.SetAccessTokenAsync(loginResult.AccessToken);
