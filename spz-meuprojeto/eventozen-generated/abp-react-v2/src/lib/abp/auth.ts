    ...
    persist(
        (set, get) => ({
            ...
            login: async (username: string, password: string) => {
                ...
                try {
                    const clientId = import.meta.env.VITE_OIDC_CLIENT_ID || "Sapienza.EventoZen_React";
                    const scope = import.meta.env.VITE_OIDC_SCOPE || "openid profile email offline_access Sapienza.EventoZen";
