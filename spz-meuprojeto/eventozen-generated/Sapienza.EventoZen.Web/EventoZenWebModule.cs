...
using Sapienza.EventoZen.Web.Menus;
...
namespace Sapienza.EventoZen.Web
{
    ...
    public class EventoZenWebModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    ...
                    typeof(EventoZenWebModule).Assembly
                );
            });
        }
        ...
        private void ConfigurePages(IConfiguration configuration)
        {
            ...
            {
                options.Conventions.AuthorizePage("/HostDashboard", EventoZenPermissions.Dashboard.Host);
                options.Conventions.AuthorizePage("/TenantDashboard", EventoZenPermissions.Dashboard.Tenant);
            });
        }
        ...
        private void ConfigureAutoMapper()
        {
            ...
            {
                options.AddMaps<EventoZenWebModule>();
            });
        }
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            ...
            {
                options.FileSets.AddEmbedded<EventoZenWebModule>();

                if (hostingEnvironment.IsDevelopment())
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<EventoZenDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}Sapienza.EventoZen.Domain.Shared", Path.DirectorySeparatorChar)));
                    options.FileSets.ReplaceEmbeddedByPhysical<EventoZenApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}Sapienza.EventoZen.Application.Contracts", Path.DirectorySeparatorChar)));
                    options.FileSets.ReplaceEmbeddedByPhysical<EventoZenWebModule>(hostingEnvironment.ContentRootPath);
        ...
        private void ConfigureNavigationServices(IConfiguration configuration)
        {
            ...
            {
                options.Contributors.Add(new EventoZenToolbarContributor());
            });
        }
