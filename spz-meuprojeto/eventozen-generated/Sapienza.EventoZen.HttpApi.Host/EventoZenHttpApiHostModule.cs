...
using Sapienza.EventoZen.MongoDB;
...
using Sapienza.EventoZen.HealthChecks;
...
{
    [DependsOn(
        typeof(EventoZenHttpApiModule),
        typeof(AbpAutofacModule),
        typeof(AbpAspNetCoreMultiTenancyModule),
        typeof(EventoZenApplicationModule),
        typeof(EventoZenMongoDbModule),
    ...
    public class EventoZenHttpApiHostModule : AbpModule
    {
         public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            PreConfigure<OpenIddictBuilder>(builder =>
            {
                ...
                {
                    options.AddAudiences("Sapienza.EventoZen");
        ...
        {
            context.Services.AddEventoZenHealthChecks();
        }
        ...
        private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
        {
            ...
            if (hostingEnvironment.IsDevelopment())
            {
                Configure<AbpVirtualFileSystemOptions>(options =>
                {
                    ...
                    options.FileSets.ReplaceEmbeddedByPhysical<EventoZenDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Sapienza.EventoZen.Domain"));
                    ...
                    options.FileSets.ReplaceEmbeddedByPhysical<EventoZenApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Sapienza.EventoZen.Application"));
        ...
        private void ConfigureConventionalControllers()
        {
            ...
            {
                options.ConventionalControllers.Create(typeof(EventoZenApplicationModule).Assembly);
            });
        }
        ...
        private void ConfigureAuthentication(ServiceConfigurationContext context, IConfiguration configuration)
        {
            context.Services.AddAuthentication()
                .AddJwtBearer(options =>
                {
                    ...
                    options.Audience = "Sapienza.EventoZen";
        ...
        private static void ConfigureSwagger(ServiceConfigurationContext context, IConfiguration configuration)
        {
            context.Services.AddAbpSwaggerGenWithOAuth(
                ...
                {
                    {"Sapienza.EventoZen", "Sapienza.EventoZen API"}
                },
                options =>
                {
