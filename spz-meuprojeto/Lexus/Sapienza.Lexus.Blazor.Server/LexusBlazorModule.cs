...
using Sapienza.Lexus.Blazor.Menus;
...
namespace Sapienza.Lexus.Blazor
{
    ...
    public class LexusBlazorModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    ...
                    typeof(LexusBlazorModule).Assembly
                );
            });
        }
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<LexusDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Sapienza.Lexus.Domain.Shared"));
                    options.FileSets.ReplaceEmbeddedByPhysical<LexusApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Sapienza.Lexus.Application.Contracts"));
                    options.FileSets.ReplaceEmbeddedByPhysical<LexusBlazorModule>(hostingEnvironment.ContentRootPath);
        ...
        private void ConfigureRouter()
        {
            ...
            {
                options.AppAssembly = typeof(LexusBlazorModule).Assembly;
            });
        }
        ...
        private void ConfigureAutoMapper()
        {
            ...
            {
                options.AddMaps<LexusBlazorModule>();
            });
        }
