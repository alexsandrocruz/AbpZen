...
/// advProcessos entity
/// </summary>
public class advProcessos : FullAuditedAggregateRoot<Guid>
{
    ...
    public virtual Sapienza.Lexus.advProcessosClientes.advProcessosClientes? advProcessosNav { get; set; }
    public virtual Sapienza.Lexus.advProcessosHonorarios.advProcessosHonorarios? advProcessosNav1 { get; set; }
    public virtual Sapienza.Lexus.advProcessosMeritos.advProcessosMeritos? advProcessosNav2 { get; set; }
    public virtual Sapienza.Lexus.advCompromissos.advCompromissos advProcessosNav3 { get; set; }
    public virtual Sapienza.Lexus.advProcessosAlteracoes.advProcessosAlteracoes? advProcessosNav4 { get; set; }
    public virtual Sapienza.Lexus.advProcessosDadosHerdeiros.advProcessosDadosHerdeiros? advProcessosNav5 { get; set; }
    public virtual Sapienza.Lexus.advTarefas.advTarefas advProcessosNav6 { get; set; }
    public virtual Sapienza.Lexus.advVerbas.advVerbas advProcessosNav7 { get; set; }

    // ========== Collection Navigation Properties (1:N - This entity is the "One" side) ==========
    public virtual ICollection<Sapienza.Lexus.advClientes.advClientes> advProcessoses { get; set; } = new List<Sapienza.Lexus.advClientes.advClientes>();

    protected advProcessos()
    {
        // Required by EF Core
    }

    public advProcessos(Guid id) : base(id)
    {
    }
}
