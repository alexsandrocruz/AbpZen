...
public class finContas : FullAuditedAggregateRoot<Guid>
{
    ...
    public virtual Sapienza.Lexus.finExtrato.finExtrato? finContasNav { get; set; }
    public virtual Sapienza.Lexus.finLancamentos.finLancamentos? finContasNav1 { get; set; }
