...
public class advProcessosAlteracoes : FullAuditedAggregateRoot<Guid>
{
    ...
    public virtual ICollection<Sapienza.Lexus.advProcessos.advProcessos> advProcessosAlteracoeses { get; set; } = new List<Sapienza.Lexus.advProcessos.advProcessos>();
