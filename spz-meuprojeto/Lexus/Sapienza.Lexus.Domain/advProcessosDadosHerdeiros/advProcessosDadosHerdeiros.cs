...
public class advProcessosDadosHerdeiros : FullAuditedAggregateRoot<Guid>
{
    ...
    public virtual ICollection<Sapienza.Lexus.advProcessos.advProcessos> advProcessosDadosHerdeiroses { get; set; } = new List<Sapienza.Lexus.advProcessos.advProcessos>();
    public virtual ICollection<Sapienza.Lexus.advProcessosHonorarios.advProcessosHonorarios> advProcessosDadosHerdeirosesCollection { get; set; } = new List<Sapienza.Lexus.advProcessosHonorarios.advProcessosHonorarios>();
