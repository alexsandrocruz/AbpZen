...
public class flwGradeHorarios : FullAuditedAggregateRoot<Guid>
{
    ...
    public virtual ICollection<Sapienza.Lexus.fabHistoricoTipos.fabHistoricoTipos> flwGradeHorarioses { get; set; } = new List<Sapienza.Lexus.fabHistoricoTipos.fabHistoricoTipos>();
