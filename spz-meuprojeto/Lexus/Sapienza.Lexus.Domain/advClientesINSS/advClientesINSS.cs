...
public class advClientesINSS : FullAuditedAggregateRoot<Guid>
{
    ...
    public virtual ICollection<Sapienza.Lexus.advClientesINSSStatus.advClientesINSSStatus> advClientesINSSes { get; set; } = new List<Sapienza.Lexus.advClientesINSSStatus.advClientesINSSStatus>();
