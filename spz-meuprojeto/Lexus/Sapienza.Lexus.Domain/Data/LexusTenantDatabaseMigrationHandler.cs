...
namespace Sapienza.Lexus.Data
{
    ...
    {
        private readonly IEnumerable<ILexusDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ICurrentTenant _currentTenant;
        private readonly IUnitOfWorkManager _unitOfWorkManager;
        private readonly IDataSeeder _dataSeeder;
        private readonly ITenantStore _tenantStore;
        private readonly ILogger<LexusTenantDatabaseMigrationHandler> _logger;

        public LexusTenantDatabaseMigrationHandler(
            IEnumerable<ILexusDbSchemaMigrator> dbSchemaMigrators,
            ICurrentTenant currentTenant,
            IUnitOfWorkManager unitOfWorkManager,
            IDataSeeder dataSeeder,
            ITenantStore tenantStore,
            ILogger<LexusTenantDatabaseMigrationHandler> logger)
        {
        ...
        public async Task HandleEventAsync(TenantCreatedEto eventData)
        {
            await MigrateAndSeedForTenantAsync(
                eventData.Id,
                eventData.Properties.GetOrDefault("AdminEmail") ?? LexusConsts.AdminEmailDefaultValue,
                eventData.Properties.GetOrDefault("AdminPassword") ?? LexusConsts.AdminPasswordDefaultValue
            );
        }
        ...
        public async Task HandleEventAsync(TenantConnectionStringUpdatedEto eventData)
        {
            ...
            await MigrateAndSeedForTenantAsync(
                eventData.Id,
                LexusConsts.AdminEmailDefaultValue,
                LexusConsts.AdminPasswordDefaultValue
            );
