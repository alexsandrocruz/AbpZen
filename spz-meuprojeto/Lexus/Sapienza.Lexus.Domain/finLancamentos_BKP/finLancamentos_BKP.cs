...
/// <summary>
/// finLancamentos_BKP entity
/// </summary>
public class finLancamentos_BKP : FullAuditedAggregateRoot<Guid>
{
    ...
    protected finLancamentos_BKP()
    {
        // Required by EF Core
    }

    public finLancamentos_BKP(Guid id) : base(id)
    {
    }
}
