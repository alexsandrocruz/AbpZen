...
/// <summary>
/// finLancamentos entity
/// </summary>
public class finLancamentos : FullAuditedAggregateRoot<Guid>
{
    ...
    public Guid finPrestacaoContasId { get; set; }

    // ========== Navigation Properties ==========
    public virtual Sapienza.Lexus.finPrestacaoContas.finPrestacaoContas finLancamentosNav { get; set; }

    // ========== Collection Navigation Properties (1:N - This entity is the "One" side) ==========
    public virtual ICollection<Sapienza.Lexus.finAreas.finAreas> finLancamentoses { get; set; } = new List<Sapienza.Lexus.finAreas.finAreas>();
    public virtual ICollection<Sapienza.Lexus.finCentrosCusto.finCentrosCusto> finLancamentosesCollection { get; set; } = new List<Sapienza.Lexus.finCentrosCusto.finCentrosCusto>();
    public virtual ICollection<Sapienza.Lexus.finContas.finContas> finLancamentosesCollection1 { get; set; } = new List<Sapienza.Lexus.finContas.finContas>();
    public virtual ICollection<Sapienza.Lexus.finPlanoContas.finPlanoContas> finLancamentosesCollection2 { get; set; } = new List<Sapienza.Lexus.finPlanoContas.finPlanoContas>();

    protected finLancamentos()
    {
        // Required by EF Core
    }

    public finLancamentos(Guid id) : base(id)
    {
    }
}
