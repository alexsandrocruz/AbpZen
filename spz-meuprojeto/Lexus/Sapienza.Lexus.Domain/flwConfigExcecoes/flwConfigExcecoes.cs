...
public class flwConfigExcecoes : FullAuditedAggregateRoot<Guid>
{
    ...
    public virtual ICollection<Sapienza.Lexus.fabHistoricoTipos.fabHistoricoTipos> flwConfigExcecoeses { get; set; } = new List<Sapienza.Lexus.fabHistoricoTipos.fabHistoricoTipos>();
