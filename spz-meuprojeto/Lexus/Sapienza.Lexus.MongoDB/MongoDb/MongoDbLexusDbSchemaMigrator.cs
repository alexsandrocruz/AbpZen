...
{
    public class MongoDbLexusDbSchemaMigrator : ILexusDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public MongoDbLexusDbSchemaMigrator(IServiceProvider serviceProvider)
        {
