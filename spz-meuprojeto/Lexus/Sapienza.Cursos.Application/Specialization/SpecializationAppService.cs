...
{
    private readonly IRepository<Sapienza.Cursos.Specialization.Specialization, Guid> _repository;

    public SpecializationAppService(
        IRepository<Sapienza.Cursos.Specialization.Specialization, Guid> repository
    )
    {
    ...
    public virtual async Task<SpecializationDto> GetAsync(Guid id)
    {
        ...
        var dto = ObjectMapper.Map<Sapienza.Cursos.Specialization.Specialization, SpecializationDto>(entity);
    ...
    public virtual async Task<PagedResultDto<SpecializationDto>> GetListAsync(SpecializationGetListInput input)
    {
        ...
        var dtoList = ObjectMapper.Map<List<Sapienza.Cursos.Specialization.Specialization>, List<SpecializationDto>>(entities);
    ...
    {
        var entity = ObjectMapper.Map<CreateUpdateSpecializationDto, Sapienza.Cursos.Specialization.Specialization>(input);

        await _repository.InsertAsync(entity, autoSave: true);

        return ObjectMapper.Map<Sapienza.Cursos.Specialization.Specialization, SpecializationDto>(entity);
    }
    ...
    public virtual async Task<SpecializationDto> UpdateAsync(Guid id, CreateUpdateSpecializationDto input)
    {
        ...
        if (entity == null)
        {
             throw new Volo.Abp.Domain.Entities.EntityNotFoundException(typeof(Sapienza.Cursos.Specialization.Specialization), id);
        }
    ...
    /// </summary>
    protected virtual IQueryable<Sapienza.Cursos.Specialization.Specialization> ApplyFilters(IQueryable<Sapienza.Cursos.Specialization.Specialization> queryable, SpecializationGetListInput input)
    {
        return queryable
