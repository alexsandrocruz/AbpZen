...
public class LawyerAppService :
    ...
    ILawyerAppService
{
    private readonly IRepository<Sapienza.Cursos.Lawyer.Lawyer, Guid> _repository;

    public LawyerAppService(
        IRepository<Sapienza.Cursos.Lawyer.Lawyer, Guid> repository
    )
    {
    ...
    public virtual async Task<LawyerDto> GetAsync(Guid id)
    {
        ...
        var dto = ObjectMapper.Map<Sapienza.Cursos.Lawyer.Lawyer, LawyerDto>(entity);
    ...
    public virtual async Task<PagedResultDto<LawyerDto>> GetListAsync(LawyerGetListInput input)
    {
        ...
        var dtoList = ObjectMapper.Map<List<Sapienza.Cursos.Lawyer.Lawyer>, List<LawyerDto>>(entities);
    ...
    {
        var entity = ObjectMapper.Map<CreateUpdateLawyerDto, Sapienza.Cursos.Lawyer.Lawyer>(input);

        await _repository.InsertAsync(entity, autoSave: true);

        return ObjectMapper.Map<Sapienza.Cursos.Lawyer.Lawyer, LawyerDto>(entity);
    }
    ...
    public virtual async Task<LawyerDto> UpdateAsync(Guid id, CreateUpdateLawyerDto input)
    {
        ...
        if (entity == null)
        {
             throw new Volo.Abp.Domain.Entities.EntityNotFoundException(typeof(Sapienza.Cursos.Lawyer.Lawyer), id);
        }
    ...
    /// </summary>
    protected virtual IQueryable<Sapienza.Cursos.Lawyer.Lawyer> ApplyFilters(IQueryable<Sapienza.Cursos.Lawyer.Lawyer> queryable, LawyerGetListInput input)
    {
        return queryable
