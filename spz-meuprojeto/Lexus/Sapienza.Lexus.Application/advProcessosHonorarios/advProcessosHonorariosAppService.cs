    ...
    IadvProcessosHonorariosAppService
{
    ...
    public virtual async Task<advProcessosHonorariosDto> GetAsync(Guid id)
    {
        ...
        var advProcessosDadosHerdeiros = await _advProcessosDadosHerdeirosRepository.FindAsync(entity.advProcessosDadosHerdeirosId);
        dto.advProcessosDadosHerdeirosDisplayName = advProcessosDadosHerdeiros?.bancarioTipoConta;
    ...
    public virtual async Task<PagedResultDto<advProcessosHonorariosDto>> GetListAsync(advProcessosHonorariosGetListInput input)
    {
        ...
        var advProcessosDadosHerdeirosIds = entities
            .Select(x => x.advProcessosDadosHerdeirosId)
            .Distinct()
            .ToList();
        ...
        if (advProcessosDadosHerdeirosIds.Any())
        {
            ...
            {
                if (parentMap.TryGetValue(dto.advProcessosDadosHerdeirosId, out var displayName))
                {
