...
public class ProposalAppService :
    ...
    IProposalAppService
{
    private readonly IRepository<Sapienza.Lexus.Proposal.Proposal, Guid> _repository;
    private readonly IRepository<Sapienza.Lexus.Client.Client, Guid> _clientRepository;

    public ProposalAppService(
        IRepository<Sapienza.Lexus.Proposal.Proposal, Guid> repository,
    ...
    public virtual async Task<ProposalDto> GetAsync(Guid id)
    {
        ...
        var dto = ObjectMapper.Map<Sapienza.Lexus.Proposal.Proposal, ProposalDto>(entity);
    ...
    public virtual async Task<ProposalDto> CreateAsync(CreateUpdateProposalDto input)
    {
        ...
        return ObjectMapper.Map<Sapienza.Lexus.Proposal.Proposal, ProposalDto>(entity);
    }
