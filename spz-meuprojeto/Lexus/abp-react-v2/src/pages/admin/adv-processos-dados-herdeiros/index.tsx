...
import { AdvProcessosDadosHerdeirosForm } from "@/components/adv-processos-dados-herdeiros/AdvProcessosDadosHerdeirosForm";
  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        <AdvProcessosDadosHerdeirosList onEdit={handleEdit} />

        <AdvProcessosDadosHerdeirosForm
          isOpen={isFormOpen}
