...
import { AdvProfissionaisEstadosForm } from "@/components/adv-profissionais-estados/AdvProfissionaisEstadosForm";
  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        <AdvProfissionaisEstadosList onEdit={handleEdit} />

        <AdvProfissionaisEstadosForm
          isOpen={isFormOpen}
