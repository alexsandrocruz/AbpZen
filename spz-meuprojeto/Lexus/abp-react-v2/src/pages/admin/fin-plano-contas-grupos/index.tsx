...
import { FinPlanoContasGruposForm } from "@/components/fin-plano-contas-grupos/FinPlanoContasGruposForm";
  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        <FinPlanoContasGruposList onEdit={handleEdit} />

        <FinPlanoContasGruposForm
          isOpen={isFormOpen}
