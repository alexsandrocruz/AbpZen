...
import { FabCondicoesPagamentoForm } from "@/components/fab-condicoes-pagamento/FabCondicoesPagamentoForm";
  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        <FabCondicoesPagamentoList onEdit={handleEdit} />

        <FabCondicoesPagamentoForm
          isOpen={isFormOpen}
