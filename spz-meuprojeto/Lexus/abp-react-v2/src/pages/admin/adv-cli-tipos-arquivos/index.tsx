...
import { AdvCliTiposArquivosForm } from "@/components/adv-cli-tipos-arquivos/AdvCliTiposArquivosForm";
  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        <AdvCliTiposArquivosList onEdit={handleEdit} />

        <AdvCliTiposArquivosForm
          isOpen={isFormOpen}
