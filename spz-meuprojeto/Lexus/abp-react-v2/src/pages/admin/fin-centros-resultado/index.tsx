...
import { FinCentrosResultadoForm } from "@/components/fin-centros-resultado/FinCentrosResultadoForm";
  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        <FinCentrosResultadoList onEdit={handleEdit} />

        <FinCentrosResultadoForm
          isOpen={isFormOpen}
