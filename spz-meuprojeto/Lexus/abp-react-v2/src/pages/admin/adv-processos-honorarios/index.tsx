...
import { AdvProcessosHonorariosForm } from "@/components/adv-processos-honorarios/AdvProcessosHonorariosForm";
  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        <AdvProcessosHonorariosList onEdit={handleEdit} />

        <AdvProcessosHonorariosForm
          isOpen={isFormOpen}
