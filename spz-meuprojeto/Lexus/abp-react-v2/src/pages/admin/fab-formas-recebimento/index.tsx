...
import { FabFormasRecebimentoForm } from "@/components/fab-formas-recebimento/FabFormasRecebimentoForm";
  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        <FabFormasRecebimentoList onEdit={handleEdit} />

        <FabFormasRecebimentoForm
          isOpen={isFormOpen}
