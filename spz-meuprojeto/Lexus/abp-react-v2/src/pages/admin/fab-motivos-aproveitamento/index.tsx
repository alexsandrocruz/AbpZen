...
import { FabMotivosAproveitamentoForm } from "@/components/fab-motivos-aproveitamento/FabMotivosAproveitamentoForm";
  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        <FabMotivosAproveitamentoList onEdit={handleEdit} />

        <FabMotivosAproveitamentoForm
          isOpen={isFormOpen}
