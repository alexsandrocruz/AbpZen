...
import { AdvProcessosMeritosForm } from "@/components/adv-processos-meritos/AdvProcessosMeritosForm";
  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        <AdvProcessosMeritosList onEdit={handleEdit} />

        <AdvProcessosMeritosForm
          isOpen={isFormOpen}
