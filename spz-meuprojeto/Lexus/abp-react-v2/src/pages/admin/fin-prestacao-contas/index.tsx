...
import { FinPrestacaoContasForm } from "@/components/fin-prestacao-contas/FinPrestacaoContasForm";
  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        <FinPrestacaoContasList onEdit={handleEdit} />

        <FinPrestacaoContasForm
          isOpen={isFormOpen}
