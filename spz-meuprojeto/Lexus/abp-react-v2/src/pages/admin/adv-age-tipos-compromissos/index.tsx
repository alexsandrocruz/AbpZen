...
import { AdvAgeTiposCompromissosForm } from "@/components/adv-age-tipos-compromissos/AdvAgeTiposCompromissosForm";
  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        <AdvAgeTiposCompromissosList onEdit={handleEdit} />

        <AdvAgeTiposCompromissosForm
          isOpen={isFormOpen}
