...
import { FabFormasPagamentoForm } from "@/components/fab-formas-pagamento/FabFormasPagamentoForm";
  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        <FabFormasPagamentoList onEdit={handleEdit} />

        <FabFormasPagamentoForm
          isOpen={isFormOpen}
