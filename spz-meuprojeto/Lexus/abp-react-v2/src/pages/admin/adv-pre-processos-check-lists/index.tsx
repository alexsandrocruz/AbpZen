...
import { AdvPreProcessosCheckListsForm } from "@/components/adv-pre-processos-check-lists/AdvPreProcessosCheckListsForm";
  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        <AdvPreProcessosCheckListsList onEdit={handleEdit} />

        <AdvPreProcessosCheckListsForm
          isOpen={isFormOpen}
