...
import { AdvProProbabilidadesForm } from "@/components/adv-pro-probabilidades/AdvProProbabilidadesForm";
  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        <AdvProProbabilidadesList onEdit={handleEdit} />

        <AdvProProbabilidadesForm
          isOpen={isFormOpen}
