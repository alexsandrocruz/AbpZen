...
import { FabPermissoesTiposForm } from "@/components/fab-permissoes-tipos/FabPermissoesTiposForm";
  ...
  return (
    <Shell>
      <div className="space-y-6">
        ...
        <FabPermissoesTiposList onEdit={handleEdit} />

        <FabPermissoesTiposForm
          isOpen={isFormOpen}
