...
public class EditModalModel : Sapienza.LexusPageModel
{
    ...
    [BindProperty]
    public EditLegalProcessViewModel ViewModel { get; set; }
    ...
    {
        var dto = await _legalProcessAppService.GetAsync(Id);
        ViewModel = ObjectMapper.Map<LegalProcessDto, EditLegalProcessViewModel>(dto);
    ...
    {
        var dto = ObjectMapper.Map<EditLegalProcessViewModel, CreateUpdateLegalProcessDto>(ViewModel);
        await _legalProcessAppService.UpdateAsync(Id, dto);
        return NoContent();
    }
}
