...
public class EditModalModel : Sapienza.LexusPageModel
{
    ...
    [BindProperty]
    public EditlogCamposViewModel ViewModel { get; set; }
    ...
    {
        var dto = await _logCamposAppService.GetAsync(Id);
        ViewModel = ObjectMapper.Map<logCamposDto, EditlogCamposViewModel>(dto);
    ...
    {
        var dto = ObjectMapper.Map<EditlogCamposViewModel, CreateUpdatelogCamposDto>(ViewModel);
        await _logCamposAppService.UpdateAsync(Id, dto);
        return NoContent();
    }
}
