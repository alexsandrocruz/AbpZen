...
{
    [BindProperty]
    public CreateadvProSentencasViewModel ViewModel { get; set; }
    ...
    {
        ViewModel = new CreateadvProSentencasViewModel();
    ...
    {
        var dto = ObjectMapper.Map<CreateadvProSentencasViewModel, CreateUpdateadvProSentencasDto>(ViewModel);
        await _advProSentencasAppService.CreateAsync(dto);
        return NoContent();
    }
}
