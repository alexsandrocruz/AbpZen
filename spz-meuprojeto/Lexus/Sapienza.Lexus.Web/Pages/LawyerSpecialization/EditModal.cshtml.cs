...
public class EditModalModel : Sapienza.LexusPageModel
{
    ...
    [BindProperty]
    public EditLawyerSpecializationViewModel ViewModel { get; set; }
    ...
    {
        var dto = await _lawyerSpecializationAppService.GetAsync(Id);
        ViewModel = ObjectMapper.Map<LawyerSpecializationDto, EditLawyerSpecializationViewModel>(dto);
    ...
    {
        var dto = ObjectMapper.Map<EditLawyerSpecializationViewModel, CreateUpdateLawyerSpecializationDto>(ViewModel);
        await _lawyerSpecializationAppService.UpdateAsync(Id, dto);
        return NoContent();
    }
}
