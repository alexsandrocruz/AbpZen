...
{
    [BindProperty]
    public CreatefabCidadesViewModel ViewModel { get; set; }
    ...
    {
        ViewModel = new CreatefabCidadesViewModel();
    ...
    {
        var dto = ObjectMapper.Map<CreatefabCidadesViewModel, CreateUpdatefabCidadesDto>(ViewModel);
        await _fabCidadesAppService.CreateAsync(dto);
        return NoContent();
    }
}
