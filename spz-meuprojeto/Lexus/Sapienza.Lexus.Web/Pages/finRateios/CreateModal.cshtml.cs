...
{
    [BindProperty]
    public CreatefinRateiosViewModel ViewModel { get; set; }
    ...
    {
        ViewModel = new CreatefinRateiosViewModel();
    ...
    {
        var dto = ObjectMapper.Map<CreatefinRateiosViewModel, CreateUpdatefinRateiosDto>(ViewModel);
        await _finRateiosAppService.CreateAsync(dto);
        return NoContent();
    }
}
