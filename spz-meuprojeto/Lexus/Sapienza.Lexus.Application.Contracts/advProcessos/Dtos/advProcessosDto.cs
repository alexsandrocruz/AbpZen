...
[Serializable]
public class advProcessosDto : FullAuditedEntityDto<Guid>
{
    ...
    public string? advProcessosClientesDisplayName { get; set; }
    public Guid? advProcessosHonorariosId { get; set; }
    public string? advProcessosHonorariosDisplayName { get; set; }
    public Guid? advProcessosMeritosId { get; set; }
    public string? advProcessosMeritosDisplayName { get; set; }
    ...
    public string? advProcessosAlteracoesDisplayName { get; set; }
    public Guid? advProcessosDadosHerdeirosId { get; set; }
    public string? advProcessosDadosHerdeirosDisplayName { get; set; }
    public Guid advTarefasId { get; set; }
    public string? advTarefasDisplayName { get; set; }
