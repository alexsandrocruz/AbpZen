...
[Serializable]
public class advClientesDto : FullAuditedEntityDto<Guid>
{
    ...
    public string? advClientesAtualizacoesDisplayName { get; set; }
    ...
    public string? advProcessosDisplayName { get; set; }
