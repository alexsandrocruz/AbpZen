...
namespace Sapienza.Lexus.finLancamentos.Dtos;

[Serializable]
public class finLancamentosDto : FullAuditedEntityDto<Guid>
{
    ...
    public string? finPrestacaoContasDisplayName { get; set; }
