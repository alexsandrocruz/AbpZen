...
namespace Sapienza.Lexus.MauiBlazor.OAuth
{
    public class CodeFlowExternalAuthService : ExternalAuthServiceBase
    {
        ...
        public CodeFlowExternalAuthService(
            ILexusApplicationSettingService leptonXDemoAppApplicationSettingService,
        ...
        public override async Task<LoginResult> LoginAsync(LoginInput input)
        {
            ...
            await LexusApplicationSettingService.SetAccessTokenAsync(loginResult.AccessToken);
