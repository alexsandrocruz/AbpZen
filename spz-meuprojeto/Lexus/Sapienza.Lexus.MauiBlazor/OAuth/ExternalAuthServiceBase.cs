...
public abstract class ExternalAuthServiceBase : IExternalAuthService
{
    ...
    protected  ILexusApplicationSettingService LexusApplicationSettingService { get;}

    protected ExternalAuthServiceBase(ILexusApplicationSettingService leptonXDemoAppApplicationSettingService)
    {
        LexusApplicationSettingService = leptonXDemoAppApplicationSettingService;
    }
    ...
    {
        var accessToken = await LexusApplicationSettingService.GetAccessTokenAsync();
