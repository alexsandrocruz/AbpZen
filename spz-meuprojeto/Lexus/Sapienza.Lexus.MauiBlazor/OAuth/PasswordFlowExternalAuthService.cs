...
public class PasswordFlowExternalAuthService : ExternalAuthServiceBase
{
    ...
    public PasswordFlowExternalAuthService(
        ...
        ILexusApplicationSettingService leptonXDemoAppApplicationSettingService) : base(leptonXDemoAppApplicationSettingService)
    {
    ...
    public override async Task<LoginResult> LoginAsync(LoginInput loginInput)
    {
        ...
        await LexusApplicationSettingService.SetAccessTokenAsync(tokenResponse.AccessToken);
    ...
    {
        await LexusApplicationSettingService.SetAccessTokenAsync(null);
