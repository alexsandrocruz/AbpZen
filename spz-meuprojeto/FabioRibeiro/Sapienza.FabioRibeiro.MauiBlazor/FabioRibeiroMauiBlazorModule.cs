using Sapienza.FabioRibeiro.MauiBlazor.OAuth;
using Blazorise;
using Blazorise.Bootstrap5;
using Blazorise.Icons.FontAwesome;
using Microsoft.AspNetCore.Components.Authorization;
using Microsoft.Extensions.Configuration;
using Sapienza.FabioRibeiro.MauiBlazor.Navigation;
...
public class FabioRibeiroMauiBlazorModule : AbpModule
{
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new FabioRibeiroMenuContributor(context.Services.GetConfiguration()));
        });
    }

    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        Configure<AbpRouterOptions>(options => { options.AppAssembly = typeof(FabioRibeiroMauiBlazorModule).Assembly; });
    }
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddMaps<FabioRibeiroMauiBlazorModule>();
        });
    }
