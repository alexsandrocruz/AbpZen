...
{
    public class FabioRibeiroDbMigrationService : ITransientDependency
    {
        public ILogger<FabioRibeiroDbMigrationService> Logger { get; set; }
        ...
        public FabioRibeiroDbMigrationService(
            ...
            IEnumerable<IFabioRibeiroDbSchemaMigrator> dbSchemaMigrators)
        {
            ...
            Logger = NullLogger<FabioRibeiroDbMigrationService>.Instance;
        }
