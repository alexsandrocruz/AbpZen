...
using Sapienza.FabioRibeiro.Blazor.Menus;
...
namespace Sapienza.FabioRibeiro.Blazor
{
    ...
    public class FabioRibeiroBlazorModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    ...
                    typeof(FabioRibeiroBlazorModule).Assembly
                );
            });
        }
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<FabioRibeiroDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Sapienza.FabioRibeiro.Domain.Shared"));
                    options.FileSets.ReplaceEmbeddedByPhysical<FabioRibeiroApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Sapienza.FabioRibeiro.Application.Contracts"));
                    options.FileSets.ReplaceEmbeddedByPhysical<FabioRibeiroBlazorModule>(hostingEnvironment.ContentRootPath);
        ...
        private void ConfigureRouter()
        {
            ...
            {
                options.AppAssembly = typeof(FabioRibeiroBlazorModule).Assembly;
            });
        }
        ...
        private void ConfigureAutoMapper()
        {
            ...
            {
                options.AddMaps<FabioRibeiroBlazorModule>();
            });
        }
