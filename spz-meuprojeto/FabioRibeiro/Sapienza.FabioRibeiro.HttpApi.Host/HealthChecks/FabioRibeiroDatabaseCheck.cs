...
{
    public class FabioRibeiroDatabaseCheck : IHealthCheck, ITransientDependency
    {
        protected readonly IIdentityRoleRepository IdentityRoleRepository;

        public FabioRibeiroDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
        {
