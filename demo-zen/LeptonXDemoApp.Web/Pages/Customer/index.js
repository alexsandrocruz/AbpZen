$(function () {
    ...
    $("#CustomerFilter :input").on('input', debounce(function () {
    ...
    var getFilter = function () {
        ...
        $("#CustomerFilter")
            ...
            .forEach(function (data) {
                if (data.value != '') {
                    input[abp.utils.toCamelCase(data.name.replace(/CustomerFilter./g, ''))] = data.value;
                }
            })
        return input;
    };
        ...
        columnDefs: [
            {
                rowAction: {
                    items: [
                        {
                            text: l('Edit'),
                            visible: abp.auth.isGranted('LeptonXDemoApp.Customer.Update'),
                        ...
                        {
                            text: l('Delete'),
                            visible: abp.auth.isGranted('LeptonXDemoApp.Customer.Delete'),
