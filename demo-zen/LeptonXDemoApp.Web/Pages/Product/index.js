$(function () {
    ...
    $("#ProductFilter :input").on('input', debounce(function () {
        ...
        columnDefs: [
            {
                rowAction: {
                    items: [
                        {
                            text: l('Edit'),
                            visible: abp.auth.isGranted('LeptonXDemoApp.Product.Update'),
                        ...
                        {
                            text: l('Delete'),
                            visible: abp.auth.isGranted('LeptonXDemoApp.Product.Delete'),
