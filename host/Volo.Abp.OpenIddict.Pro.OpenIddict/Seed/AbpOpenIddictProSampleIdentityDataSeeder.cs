 ...
 * - Volo.Abp.OpenIddict.Pro.OpenIddict
 * - Volo.Abp.OpenIddict.Pro.Web.Unified (used as linked file)
 */
public class AbpOpenIddictProSampleIdentityDataSeeder : ITransientDependency
{
    ...
    public AbpOpenIddictProSampleIdentityDataSeeder(
