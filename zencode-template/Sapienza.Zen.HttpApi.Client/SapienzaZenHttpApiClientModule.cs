...
{
    [DependsOn(
        typeof(SapienzaZenApplicationContractsModule),
    ...
    public class SapienzaZenHttpApiClientModule : AbpModule
    {
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            {
                options.FileSets.AddEmbedded<SapienzaZenHttpApiClientModule>();
            });
        }
    }
}
