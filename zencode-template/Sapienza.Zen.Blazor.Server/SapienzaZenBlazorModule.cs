...
using Sapienza.Zen.Blazor.Menus;
...
namespace Sapienza.Zen.Blazor
{
    ...
    public class SapienzaZenBlazorModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    ...
                    typeof(SapienzaZenBlazorModule).Assembly
                );
            });
        }
        ...
        private void ConfigureRouter()
        {
            ...
            {
                options.AppAssembly = typeof(SapienzaZenBlazorModule).Assembly;
            });
        }
        ...
        private void ConfigureAutoMapper()
        {
            ...
            {
                options.AddMaps<SapienzaZenBlazorModule>();
            });
        }
