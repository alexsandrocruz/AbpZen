...
namespace Sapienza.Zen.MauiBlazor.Navigation;

public class SapienzaZenMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public SapienzaZenMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<SapienzaZenResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                SapienzaZenMenus.Home,
                "Home",
                "/",
                icon: "fas fa-home",
                order: 1
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                SapienzaZenMenus.HostDashboard,
                l["Menu:Dashboard"],
                "/HostDashboard",
                icon: "fa fa-chart-line",
                order: 2
            ).RequirePermissions(SapienzaZenPermissions.Dashboard.Host)
        );

        //TenantDashboard
        context.Menu.AddItem(
            new ApplicationMenuItem(
                SapienzaZenMenus.TenantDashboard,
                l["Menu:Dashboard"],
                "/Dashboard",
                icon: "fa fa-chart-line",
                order: 2
            ).RequirePermissions(SapienzaZenPermissions.Dashboard.Tenant)
        );
