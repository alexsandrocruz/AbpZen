...
public class Lock : IdentityPageModel
{
    ...
    public virtual async Task OnGetAsync(Guid id)
    {
        ...
        {
            Id = id,
            LockoutEnd = user.LockoutEnd?.LocalDateTime ?? DateTime.Now.AddDays(7).Date
        };
    }
    ...
    public virtual async Task<IActionResult> OnPostAsync()
    {
        ...
        await IdentityUserAppService.LockAsync(LockInput.Id, LockInput.LockoutEnd.ToUniversalTime());
