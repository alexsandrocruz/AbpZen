...
using Volo.Abp.Identity.Web.Pages.Identity.Users.ExportToolbar;
using Volo.Abp.Identity.Web.Pages.Identity.Users.ImportToolbar;
...
public class AbpIdentityWebModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.ScriptBundles
                .Configure(typeof(Volo.Abp.Identity.Web.Pages.Identity.Users.IndexModel).FullName,
                    configuration =>
                    {
        ...
        Configure<AbpPageToolbarOptions>(options =>
        {
            options.Configure<Volo.Abp.Identity.Web.Pages.Identity.Users.IndexModel>(
                toolbar =>
                {
                    toolbar.AddComponent<ImportDropdownViewComponent>(requiredPolicyName: IdentityPermissions.Users.Import);
                    toolbar.AddComponent<ExportDropdownViewComponent>(requiredPolicyName: IdentityPermissions.Users.Export);
        ...
        {
            options.DisableModule(IdentityProRemoteServiceConsts.ModuleName);
        });
