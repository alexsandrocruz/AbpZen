...
public class MenuViewModelProvider : ITransientDependency
{
    ...
    protected IObjectMapper<AbpAspNetCoreMvcUiLeptonXThemeModule> ObjectMapper { get; }


    public MenuViewModelProvider(IMenuManager menuManager, IPageLayout pageLayout, IObjectMapper<AbpAspNetCoreMvcUiLeptonXThemeModule> objectMapper)
    {
