...
using Volo.Abp.AuditLogging.Web.Settings;
...
public class AbpAuditLoggingWebModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.DisableModule(AuditLoggingRemoteServiceConsts.ModuleName);
        });

        Configure<SettingManagementPageOptions>(options =>
        {
            options.Contributors.Add(new AuditLogSettingManagementPageContributor());
        });
