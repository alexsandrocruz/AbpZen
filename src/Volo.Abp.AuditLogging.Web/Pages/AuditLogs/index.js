...
$('#EntityChanges-tab').on('shown.bs.tab', function () {
    if (_entityChangeDataTable) {
        _entityChangeDataTable.ajax.reloadEx();
    }
})
...
$("#ClearEntityChangeFilterButton").click(function (e) {
    e.preventDefault();

    $("#EntityChangeStartTime").val("");
    $("#EntityChangeEndTime").val("");
    $("#EntityChangeChangeType").val("");
    $("#EntityId").val("");
    $("#EntityChangeEntityTypeFullName").val("");
