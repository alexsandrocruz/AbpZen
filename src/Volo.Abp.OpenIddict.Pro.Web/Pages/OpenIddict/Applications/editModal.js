var abp = abp || {};
$(function () {
    abp.modals.applicationUpdate = function () {
        ...
        function showOrHidePostLogoutRedirectUrisInput(){
            if($("#Application_AllowLogoutEndpoint").is(':checked')){
        ...
        function showOrHideClientSecretInput(){
            if($("#Application_ClientType").val() === "public"){
        ...
        function showOrHideConfidentialFlowInputs(){
            var clientType = $('#Application_ClientType').val();
        ...
        var initModal = function (publicApi, args) {
            ...
            showOrHideInputs();
            showOrHidePostLogoutRedirectUrisInput();
            showOrHideClientSecretInput();
            ...
            $("#Application_ClientType").change(function(){
                showOrHideConfidentialFlowInputs();
                showOrHideClientSecretInput();
            })
        };
