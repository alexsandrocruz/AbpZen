(function ($) {
            ...
            return actionList.addManyTail(
                [
                    ...
                    },
                    {
                        ...
                        visible: abp.auditLogging !== undefined && abp.auth.isGranted('AuditLogging.ViewChangeHistory:Volo.Abp.OpenIddict.Pro.Scopes.Scope'),
                        action: function (data) {
    ...
    $(function () {
        ...
        _dataTable = $('#ScopesTable').DataTable(abp.libs.datatables.normalizeConfiguration({
            ...
            scrollCollapse: true,
            order: [[1, "desc"]],
            ajax: abp.libs.datatables.createAjax(volo.abp.openIddict.scope.getList, getFilter),
