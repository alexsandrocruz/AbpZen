...
public class IdentitySettingsAppService : IdentityAppServiceBase, IIdentitySettingsAppService
{
    ...
    public virtual async Task<IdentitySettingsDto> GetAsync()
    {
        ...
        return new IdentitySettingsDto
        {
            Password = new IdentityPasswordSettingsDto
            {
                ...
                ForceUsersToPeriodicallyChangePassword = await SettingProvider.GetAsync(IdentitySettingNames.Password.ForceUsersToPeriodicallyChangePassword, false),
                PasswordChangePeriodDays = await SettingProvider.GetAsync<int>(IdentitySettingNames.Password.PasswordChangePeriodDays),
            },
    ...
    public virtual async Task UpdateAsync(IdentitySettingsDto input)
    {
        ...
        if (input.Password != null)
        {
            ...
            await SettingManager.SetForCurrentTenantAsync(IdentitySettingNames.Password.ForceUsersToPeriodicallyChangePassword, input.Password.ForceUsersToPeriodicallyChangePassword.ToString());
            await SettingManager.SetForCurrentTenantAsync(IdentitySettingNames.Password.PasswordChangePeriodDays, input.Password.PasswordChangePeriodDays.ToString());
        }
    ...
    public virtual async Task<IdentityOAuthSettingsDto> GetOAuthAsync()
    {
        return new IdentityOAuthSettingsDto
        {
            ...
            ValidateEndpoints = await SettingProvider.GetAsync<bool>(IdentityProSettingNames.OAuthLogin.ValidateEndpoints),
            ValidateIssuerName = await SettingProvider.GetAsync<bool>(IdentityProSettingNames.OAuthLogin.ValidateIssuerName),
        };
    }
    ...
    public virtual async Task UpdateOAuthAsync(IdentityOAuthSettingsDto input)
    {
        if (input != null)
        {
            ...
            await SettingManager.SetForCurrentTenantAsync(IdentityProSettingNames.OAuthLogin.ValidateEndpoints, input.ValidateEndpoints.ToString());
            await SettingManager.SetForCurrentTenantAsync(IdentityProSettingNames.OAuthLogin.ValidateIssuerName, input.ValidateIssuerName.ToString());
        }
    }
