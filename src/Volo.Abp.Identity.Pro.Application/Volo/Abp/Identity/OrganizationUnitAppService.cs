...
public class  OrganizationUnitAppService : IdentityAppServiceBase, IOrganizationUnitAppService
{
    ...
    public virtual async Task<PagedResultDto<IdentityRoleDto>> GetRolesAsync(Guid id,
    ...
    public virtual async Task<PagedResultDto<IdentityUserDto>> GetMembersAsync(Guid id, GetIdentityUsersInput input)
    {
        ...
        var userDtos = await FillIdentityUserDtoAsync(IdentityUserRepository, IdentityProTwoFactorManager, users);
    ...
    {
        await UserManager.UpdateOrganizationAsync(id, null);
    ...
    public virtual async Task<PagedResultDto<IdentityRoleDto>> GetAvailableRolesAsync(GetAvailableRolesInput input)
    {
        ...
        var roles = await OrganizationUnitRepository.GetUnaddedRolesAsync(ou, input.Sorting, input.MaxResultCount,
    ...
    [Authorize(IdentityPermissions.OrganizationUnits.ManageUsers)]
    public virtual async Task MoveAllUsersAsync(Guid id, Guid? targetOrganizationId)
    {
        await UserManager.UpdateOrganizationAsync(id, targetOrganizationId);
    }
    ...
    )
    {
        ...
        dto.UserCount = await OrganizationUnitRepository.GetMembersCountAsync(organizationUnit);
