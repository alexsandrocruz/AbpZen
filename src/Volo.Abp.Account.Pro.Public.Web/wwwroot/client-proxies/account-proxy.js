...
(function(){
  ...
  // controller volo.abp.account.accountExternalLogin

  (function(){

    abp.utils.createNamespace(window, 'volo.abp.account.accountExternalLogin');

    volo.abp.account.accountExternalLogin.getList = function(ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/account/externallogin',
        type: 'GET'
      }, ajaxParams));
    };

    volo.abp.account.accountExternalLogin['delete'] = function(loginProvider, providerKey, ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/account/externallogin/' + loginProvider + '/' + providerKey + '',
        type: 'DELETE',
        dataType: null
      }, ajaxParams));
    };

    volo.abp.account.accountExternalLogin.hasPasswordVerified = function(userId, loginProvider, providerKey, ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/account/externallogin/password-verified/' + userId + '/' + loginProvider + '/' + providerKey + '',
        type: 'GET'
      }, ajaxParams));
    };

    volo.abp.account.accountExternalLogin.setPasswordVerified = function(loginProvider, providerKey, ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/account/externallogin/password-verified/' + loginProvider + '/' + providerKey + '',
        type: 'POST',
        dataType: null
      }, ajaxParams));
    };

    volo.abp.account.accountExternalLogin.removePasswordVerified = function(loginProvider, providerKey, ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/account/externallogin/' + loginProvider + '/' + providerKey + '/password-verified',
        type: 'DELETE',
        dataType: null
      }, ajaxParams));
    };
  ...
  // controller volo.abp.account.accountSession

  (function(){

    abp.utils.createNamespace(window, 'volo.abp.account.accountSession');

    volo.abp.account.accountSession.getList = function(input, ajaxParams) {
      return abp.ajax($.extend(true, {
    ...
    volo.abp.account.accountSession.get = function(id, ajaxParams) {
      return abp.ajax($.extend(true, {
    ...
    volo.abp.account.accountSession.revoke = function(id, ajaxParams) {
      return abp.ajax($.extend(true, {
        url: abp.appPath + 'api/account/sessions/' + id + '',
        type: 'DELETE',
        dataType: null
