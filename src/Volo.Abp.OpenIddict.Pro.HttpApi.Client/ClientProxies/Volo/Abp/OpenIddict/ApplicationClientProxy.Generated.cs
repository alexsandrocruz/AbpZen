...
public partial class ApplicationClientProxy : ClientProxyBase<IApplicationAppService>, IApplicationAppService
{
    ...
    {
        return await RequestAsync<ApplicationTokenLifetimeDto>(nameof(GetTokenLifetimeAsync), new ClientProxyRequestTypeValue
        {
            { typeof(Guid), id }
        });
    }
    ...
    {
        await RequestAsync(nameof(SetTokenLifetimeAsync), new ClientProxyRequestTypeValue
        {
            { typeof(Guid), id },
            { typeof(ApplicationTokenLifetimeDto), input }
        });
    }
}
