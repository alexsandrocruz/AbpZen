        ...
        var initModal = function (publicApi, args) {
            publicApi.getModal()
                ...
                .change(function () {
                    ...
                    adjustDefaultConnectionStringInputValidation();
                });
            ...
            publicApi.getModal()
                ...
                .click(function () {
                    ...
                    volo.saas.host.tenant.checkConnectionString(databaseConnectionString).then(function (result) {
                        if (result) {
            ...
            $("#CheckConnectionString").click(function () {
                ...
                volo.saas.host.tenant.checkConnectionString(connectionString).then(function (result) {
                    if (result) {
                        abp.notify.success(l('ValidConnectionString'));
                    }
                    else {
            ...
            function adjustDefaultConnectionStringInputValidation() {
                var useSharedDatabase = publicApi.getModal().find('input[name="ConnectionStrings.UseSharedDatabase"]').is(":checked");
    
                if(!useSharedDatabase) {
                    $('input[name="ConnectionStrings.Default"]').attr("required", true);
                }
                else {
                    $('input[name="ConnectionStrings.Default"]').removeAttr("required");
                }
            }
