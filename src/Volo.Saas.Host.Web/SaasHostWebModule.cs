...
public class SaasHostWebModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<RazorPagesOptions>(options =>
        {
            ...
            options.Conventions.AuthorizePage("/Saas/Host/Tenants/SetPassword", SaasHostPermissions.Tenants.SetPassword);
        ...
        {
            options.DisableModule(SaasHostRemoteServiceConsts.ModuleName);
        });
