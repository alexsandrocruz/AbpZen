...
namespace Volo.Payment.Requests.ClientProxies;
...
{
    public virtual async Task<PaymentRequestWithDetailsDto> CompleteAsync(string paymentMethod, Dictionary<String,String> parameters)
    {
    ...
    public virtual async Task<bool> HandleWebhookAsync(string paymentMethod, string payload, Dictionary<String,String> headers)
    {
