...
public class SaasHostPermissionDefinitionProvider : PermissionDefinitionProvider
{
    public override void Define(IPermissionDefinitionContext context)
    {
        ...
        tenantsPermission.AddChild(SaasHostPermissions.Tenants.SetPassword, L("Permission:SetPassword"), multiTenancySide: MultiTenancySides.Host);
        ...
        tenantsPermission.AddChild(SaasHostPermissions.Tenants.Impersonation, L("Permission:Impersonation"), multiTenancySide: MultiTenancySides.Host);
