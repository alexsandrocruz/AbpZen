...
public class IdentityPermissionDefinitionProvider : PermissionDefinitionProvider
{
    public override void Define(IPermissionDefinitionContext context)
    {
        ...
        editPermission.AddChild(IdentityPermissions.Users.ManageOU, L("Permission:ManageOU"));
        ...
        usersPermission.AddChild(IdentityPermissions.Users.Impersonation, L("Permission:Impersonation"));
        ...
        usersPermission.AddChild(IdentityPermissions.Users.ViewDetails, L("Permission:ViewDetails"));
        ...
        var sessionPermission = identityGroup.AddPermission(IdentityPermissions.Sessions.Default, L("Permission:Sessions"));
